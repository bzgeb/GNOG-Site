...
(function($, window, document, undefined) {
	...
	Snowfall.prototype = {
		...
		defaults:{
			...
			width: 100,								//In case of sizingMode explicit: use this width for the canvas
			height: 100,							//In case of sizingMode explicit: use this height for the canvas	

			//Amount of particles
			amount: 10,								//Amount of particles that will be created
			...
			verticalSpeed: 1,						//Somewhere between 0.5 and 10 works best
			...
			radius: 8,								//In case graphicMode false: radius for drawn circles
			...
			maxiumRandomRadius:8,					//In case graphicMode false: maximum random radius
			graphics: [
